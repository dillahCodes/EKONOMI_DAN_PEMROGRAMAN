    ...
    <div className="mx-auto transition-all duration-300 shadow-md text-black dark:text-slate-300 dark:shadow-black card w-[450px] bg-[#fbf9f9] dark:bg-gray-700">
      <div className="text-black card-body dark:text-slate-300">
        <div className="flex flex-wrap items-center gap-x-3">
          <h2 className="text-black capitalize card-title dark:text-slate-300">{title}</h2> <span className={`block w-5 h-5 ${status === "coming_soon" ? "bg-blue-500" : ""}${status === "available" ? "bg-green-500" : ""}${status === "maintenance" ? "bg-red-500" : ""} rounded-full`}></span>
        </div>
