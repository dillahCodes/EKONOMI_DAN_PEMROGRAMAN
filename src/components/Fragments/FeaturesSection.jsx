...
const FeaturesSection = () => {
  const featuresData = [
    ...
    { title: "Change in Demand  (perubahan fungsi permintaan) ", description: ["calculate the Change in Demand🧮", "Market Equilibrium with Change in Demand curve📈"], Url: "/ChangeInDemand", status: "maintenance" },
    { title: "Change in Supply  (perubahan fungsi penawaran) ", description: ["calculate the Change in Supply🧮", "Market Equilibrium with Change in Supply curve📈"], Url: "/comingSoon", status: "coming_soon" },
    { title: "Change in Supply and Demand  (perubahan fungsi penawaran dan permintaan) ", description: ["calculate the Change in Supply and Demand🧮", "Market Equilibrium with Change in Supply and Demand curve📈"], Url: "/comingSoon", status: "coming_soon" },
