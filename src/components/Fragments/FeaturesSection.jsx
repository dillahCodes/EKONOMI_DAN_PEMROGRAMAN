...
const FeaturesSection = () => {
  const featuresData = [
    ...
    { title: "Change in Supply  (perubahan fungsi penawaran) ", description: ["calculate the Change in Supply🧮", "Market Equilibrium with Change in Supply curve📈"], Url: "/ChangeInSupply", status: "maintenance" },
