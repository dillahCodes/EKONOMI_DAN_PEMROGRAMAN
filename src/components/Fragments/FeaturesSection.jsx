...
const FeaturesSection = () => {
  const featuresData = [
    ...
    { title: "income elasticity of demand (Elastisitas permintaan pendapatan )", description: ["calculate the income elasticity of demand🧮"], Url: "/IncomeElasticityOfDemand", status: "available" },
  ];
