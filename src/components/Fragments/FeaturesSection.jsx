...
const FeaturesSection = () => {
  const featuresData = [
    ...
    { title: "Change in Demand  (perubahan fungsi permintaan) ", description: ["calculate the Change in Demand🧮", "Market Equilibrium with Change in Demand curve📈"], Url: "/comingSoon", status: "coming_soon" },
