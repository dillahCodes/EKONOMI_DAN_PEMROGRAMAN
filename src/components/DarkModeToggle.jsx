...
const DarkMOdeToggle = (props) => {
  ...
  return (
    <label className="text-orange-400 transition-all duration-700 dark:text-slate-300 swap swap-rotate ">
      {/* this hidden checkbox controls the state */}
      <input type="checkbox" checked={darkMode} onClick={darkModeHandler} onChange={darkModeHandler} />
