...
const TablePriceElasticityOfDemand = ({ getAllValue }) => {
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              {" "}
              <div className="w-[full]">
                <InputValue placeholder={"Quantity"} onChange={(event) => ONCHANGE_VALUE_HANDLER("QUANTITY_1", event)} />
              </div>
            </td>
          </tr>
          {/* row 2 */}
          <tr>
            ...
            <td>
              <div className="w-[full]">
                <InputValue placeholder={"Quantity"} onChange={(event) => ONCHANGE_VALUE_HANDLER("QUANTITY_2", event)} />
              </div>
            </td>
          </tr>
        </tbody>
...
TablePriceElasticityOfDemand.propTypes = {
  getAllValue: PropTypes.func,
};

export default TablePriceElasticityOfDemand;
