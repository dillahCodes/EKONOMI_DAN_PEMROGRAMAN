...
const DemandFunctionPage = () => {
  ...
  return (
    <>
      <div className="flex items-center flex-col gap-y-5 min-h-screen   justify-around w-full  text-black dark:text-slate-300    bg-[#F5F5F5] dark:bg-slate-800 transition-all  ease-out duration-700">
        <h1 className="px-3 text-xl text-center text-black mt-28 sm:text-2xl md:text-3xl font-Oswald dark:text-slate-300">demand function (fungsi permintaan)</h1>
